  ...
  <div v-if="order">
    ...
    <div>
      ...
      <table>
        ...
        <tr>
          <td class="font-bold py-1 px-2">Total (Item price + Delivery Charge)</td>
          <td>{{ $filters.currencyINR(order.total_price) }}</td>
        </tr>
        <tr>
          <td class="font-bold py-1 px-2">couponCode</td>
    ...
    <!--/  Order Details-->
<div>
      <!-- <h2 class="text-xl font-semibold mt-6 pb-2 border-b border-gray-300">Delivery Charge</h2>
      <div>
        {{ $filters.currencyINR(calculateDeliveryCharge()) }}
      </div> -->
    </div>
    <!--  Customer Details-->
    <div>
...
const calculateDeliveryCharge = () => {
  ...
  const deliveryCharge = order.value.total_price - itemsTotal;
