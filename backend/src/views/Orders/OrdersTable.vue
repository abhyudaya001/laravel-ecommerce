    ...
    <table class="table-auto w-full">
      <thead>
        <tr>
          ...
          <TableHeaderCell field="couponCode"> Coupon_code </TableHeaderCell>
          <TableHeaderCell field="pdf_id"> Document </TableHeaderCell>
        </tr>
      </thead>
      ...
      <tbody v-else>
        <tr v-for="(order, index) of orders.data">
          ...
          <td class="border-b p-2">{{ order.couponCode }}</td>
          <td class="border-b p-2">
            <a v-if="order.pdf_id" :href="getDocumentLink(order)">
              View/Download PDF
            </a>
...
// Set a common base URL for your API requests
axios.defaults.baseURL = "VITE_API_BASE_URL";

// Set headers for all requests
axios.defaults.headers.common["Access-Control-Allow-Origin"] =
  "VITE_API_BASE_URL"; // Replace with your Vue app's domain
axios.defaults.headers.common["Content-Type"] = "application/pdf"; // Adjust as needed
...
function getDocumentLink(order) {
  if (order.pdf_id) {
