            ...
            <DialogPanel
              ...
              <header class="py-3 px-4 flex justify-between items-center">
                <DialogTitle as="h3" class="text-lg leading-6 font-medium text-gray-900">
                  {{ coupon.id ? `Update coupon: "${props.coupon.discount}"` : 'Create new Coupon' }}
                </DialogTitle>
                <button
                  @click="closeModal()"
              ...
              <form @submit.prevent="onSubmit">
                <div class="bg-white px-4 pt-5 pb-4">
                  ...
                  <CustomInput type="number" class="mb-2" v-model="coupon.discount" label="Discount"/>
                  <CustomInput type="date" class="mb-2" v-model="coupon.frequency" label="Total Quantity"/>
...
const coupon = ref({
  ...
  frequency: props.coupon.frequency,
  // Add other coupon properties here
});
